...
class AccountsRepository implements IAccountsRepository {
  ...
  async create({id, país, username, role, status, sex, sexualOption, preferenceSex, preferenceSexualOption, sign, birthDate, email, phone, online, patron, password, nickname, avatar, cover, relationship, city, uf, cep, latitude, longitude }: IAccountsDTO) {
    const account: Accounts = new Accounts();
     
      Object.assign(account, {
        id, _id: id, país, username, role, status, sex, sexualOption, preferenceSex, preferenceSexualOption, sign, birthDate, email, phone, online, patron, password, nickname, avatar, cover, relationship, city, uf, cep, latitude, longitude ,created_at: new Date(),
      });
  ...
  update({país, username, role, status, sex, sexualOption, preferenceSex, preferenceSexualOption, sign, birthDate, email, phone, online, patron, nickname, avatar, cover, relationship, city, uf, password, cep, latitude, longitude}):void {}
